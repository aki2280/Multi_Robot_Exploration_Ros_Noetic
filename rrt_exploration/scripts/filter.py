...
# wait if any of robots' global costmap map is not received yet
    ...
    global_frame = "/"+mapData1.header.frame_id
#---------------------------------------------------------------------------------------------------------------  
    try:
    ...
    for i in range(0, len(robot_namelist)):
        rospy.loginfo('Transforming - ' + robot_namelist[i] +'/'+robot_frame + ' in ' + global_frame)
        tfLisn.waitForTransform(global_frame, robot_namelist[i] +'/'+robot_frame, rospy.Time(0), rospy.Duration(10.0))
...
# clearing old frontiers
        ...
        while c < len(centroids):
            ...
            for j in range(8):
                ...
                for k in range(8):
                    if k<4:
                        check1=check1-mapData1.info.resolution
                        arr=[check1,m[1]]
                        if (gridValue(mapData1,arr) !=100 ) and (gridValue(mapData2,arr) !=100 ) and (gridValue(mapData3,arr) !=100 ) and (gridValue(mapData,arr) !=100 ) :   
                            continue
                        else:
                        ...
                        m[0]=check1+k*mapData1.info.resolution
                        arr=[m[0],m[1]]
                        if (gridValue(mapData1,arr) !=100 ) and (gridValue(mapData2,arr) !=100 ) and (gridValue(mapData3,arr) !=100 ) and (gridValue(mapData,arr) !=100 ) :   
                            continue
                        else:
                ...
                if a==1:
                    ...
                    if j<4:
                        check2=check2-mapData1.info.resolution
                        m[1]=check2
                
                    elif j>=4:
                        m[1]=check2+j*mapData1.info.resolution
