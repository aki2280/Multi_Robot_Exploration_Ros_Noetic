...
def velCallback(data):
	...
	if not_first_callback:
		...
		Integral_sum+= (Integral_sum_L + Integral_sum_R)/1000
...
#---------------------------------------------------------------------------------------------------------------
	...
	rospy.Subscriber('tb3_0/cmd_vel', Twist, velCallback)
...
#-------------------------------------------------------------------------            
		...
		rospy.loginfo("frontier points:"+str(frontiers))
