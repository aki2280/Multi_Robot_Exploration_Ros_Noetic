...
# wait if any of robots' global costmap map is not received yet
    ...
    global_frame = "/"+mapData3.header.frame_id
#---------------------------------------------------------------------------------------------------------------  
    try:
...
#---------------------------------------------------------------------------------------------------------------
    ...
    pub = rospy.Publisher('frontiers', Marker, queue_size=100)
    pub2 = rospy.Publisher('centroids', Marker, queue_size=100)
    filterpub = rospy.Publisher('filtered_points', PointArray, queue_size=100)
